...
public class InstructionTest {
    ...
    public void djnz() {
        ...
        List<Integer> machineCodes = djnz.toMachineCodes(null, Arrays.asList(firstOperand, secondOperand));
        assertEquals(machineCodes.size(), 3);
        ...
        machineCodes = djnz.toMachineCodes(null, Arrays.asList(firstOperand, secondOperand));
        assertEquals(machineCodes.size(), 2);
